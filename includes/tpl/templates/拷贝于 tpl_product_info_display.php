...
?>
    ...
    <div id="product_info_con" class="fr">
      ...
      <div class="fl pad_product line_180">
        ...
        <!--eof Product Name-->
        <ul class="pad_10px">
          <li>model:&nbsp;<?php echo $products_model; ?></li>
          <div class="hr_d"></div>
        <!--bof Product Price block -->
        <li class="big margin_t"> Store Price: <del>
          <?php
						// base price
        ...
        <h3 class="relative">Website Price:<div id="t_p"><ul><li><a class="one u b_" href="javascript:void(0)"> <?php echo $currencies->display_symbol_left($_SESSION['currency']);?><!--[if IE 7]><!--></a><!--<![endif]--><!--[if lte IE 6]><table><tr><td><![endif]-->
