...
if(is_array($products_image_medium)){
  ?>
   ...
   <ul>
      <span class="p_f_en"> &nbsp; click above to zoom in</span>
    </ul>
...
?>
   ...
   <!-- add facebook twitter mark star t-->
 
 
 <div style="float:left; margin-top:35px; margin-left:10px; width:300px; ">
       
 <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script>
  <fb:like href="http://customdolls.com.au/" show_faces="false" width="300" font=""></fb:like> </div>
  
  <div style="float:left;margin-top:10px; margin-left:10px; ">
    <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:send href="http://customdolls.com.au" font="arial"></fb:send>   
