...
<div style="" id="add_insurance">
  <ul class="black">
    <div id="insurance_lab" style="visibility:hidden">
...
<p ><img border="0" src="includes/templates/<?php echo $template_dir; ?>/images/checkout/pic_1.jpg"/></p>
...
<div class="pad_l_28px margin_t big_">
  <ul>
    If you have special instructions for your order, please let us know!<br/>
    <span class="red">or, you can write down the special size of the dress you want. Thanks.</span>
  </ul>
