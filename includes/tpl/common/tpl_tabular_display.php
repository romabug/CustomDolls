...
<dd>
	...
	<li>
	   <dl>	   
	    <dd> <?php /*  取消商店价格  Store Price: <del class="red"><strong><?php echo $list_box_contents[$row]['products_price_retail']; ?></strong></del>
		  */ ?>
      ...
      <strong>Sample Price: </strong><strong class="red big"><?php echo $list_box_contents[$row]['products_price_sample'] ?></strong><br/>
	    <?php }else{ ?>
      <strong>Online Price: </strong><strong class="red big"><?php echo $currencies->display_price($list_box_contents[$row]['products_price'],zen_get_tax_rate($products_tax_class_id)); ?></strong><br/>
