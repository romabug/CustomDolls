...
// choose box images based on box position    下面一句 注销掉，不显示 SEE ALL
  if ($title_link) {
    $title = '<a href=""><span  > </span></a>';
  }
//
?>
<!--// bof: <?php echo $box_id; ?> //-->
...
<div style="position: relative; z-index: 200; height: 70px; float: left;" id="menu_btn">
	<span id="litbBtn" style="DISPLAY: block; Z-INDEX: 11; BACKGROUND: url(includes/templates/lightinthebox/images/menu_arrow.gif) no-repeat; LEFT: 10px; OVERFLOW: hidden; WIDTH: 162px; CURSOR: pointer; POSITION: absolute; TOP: 18px; HEIGHT: 17px"></span>
...
<script type="text/javascript">
 ...
 if(closeMenu){
 $("litbCon2").style.display = 'none';$("litbBtn").style.backgroundPosition="0 0";
 }else{
 $("litbCon2").style.display = 'block';$("litbBtn").style.backgroundPosition = '0 -16px';
 }
 }
