...
<div style=" padding-left:15px; padding-right:10px;  background-color: #EFEFEF">
<h2 class="border_b line_30px">
 <?php echo HEADING_TITLE .' - '. $product_info->fields['products_name']; ?></h2> </div>
