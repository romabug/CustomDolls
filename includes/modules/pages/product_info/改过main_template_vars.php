 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  p.products_discount_type, p.products_discount_type_from, p.products_sort_order, p.products_price_sorter, ppmm.metatags_description
           from   " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd,   " . TABLE_META_TAGS_PRODUCTS_DESCRIPTION . " ppmm
		   
         where  p.products_status = '1'
           and    p.products_id = '" . (int)$_GET['products_id'] . "'
           and    pd.products_id = p.products_id
		   and    ppmm.products_id = p.products_id
           and    pd.language_id = '" . (int)$_SESSION['languages_id'] . "'";
