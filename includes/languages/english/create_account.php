...
define('EMAIL_WELCOME',  'You have successfully created an account on' . "\n" . 'online store - ' . STORE_NAME . '.');
...
define('EMAIL_TEXT', 'The account you just set up allows you to securely store all your ordering information, so that your purchase on our website is simple and safe as well as much pleasures. With your account, you can now take part in the various services we have to offer you. Some of these services include: <strong>Permanent Cart,</strong>  <strong>Address Book,</strong>  <strong>Order History,</strong>  <strong>Products Reviews etc..</strong> </br>' . "\n\n" . '</br></br><strong>Custom doll as gifts</strong> </br>Custom Dolls are ageless, timeless and can suit any occasion or any theme. Be it a wedding, engagement to valentines days, or just for the special him or her, Custom Dolls choices are many and varied. Our special teams of expert artisans can create similar look alike dolls just for the right person and for the perfect occasion. Business executives, sportsmen, artists and pets custom dolls gifts with different themes and styles are the specialty and the secret of our success. </br></br>

Gift a custom doll today and be ensured that you will be remembered forever. Normal gifts are generally thrown away, given off or boxed up for good, in time. But our custom dolls gifts will be displayed and will win the appreciation from all people at all times.  ' . "\n\n");
