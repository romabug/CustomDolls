...
define('TEXT_SELECTED_BILLING_DESTINATION', '<strong> I have a Coupon for this order. </strong> <br> *  1 coupon code can be used for 1 order only ');
...
define('TABLE_HEADING_COMMENTS',  'Instructions');
